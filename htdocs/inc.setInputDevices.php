...
?>
  ...
  <li class="list-group-item">
	<div class="row">
		<div class="col-xs-6">
<?php
$gpiostatus = exec("/bin/systemctl status phoniebox-card-presence-sensor.service | grep running");
if ($gpiostatus != "") {
	print $lang['globalCardPresenceSensor'].' <span class="label label-success">'.$lang['globalEnabled'].'</span>';
	print '</div><!-- / .col-xs-6 -->';
	print '<div class="col-xs-6">';
	print "<a href='?cardpresencesensorstatus=turnoff' class='btn btn-sm btn-danger'><i class='mdi mdi-cancel'></i> ".$lang['globalSwitchOff']."</a>";
}
else {
	print $lang['globalCardPresenceSensor'].' <span class="label label-danger">'.$lang['globalDisabled'].'</span>';
	print '</div><!-- / .col-xs-4 -->';
	print '<div class="col-xs-4">';
	print "<a href='?cardpresencesensorstatus=turnon' class='btn btn-sm btn-success'><i class='mdi mdi-play'></i> ".$lang['globalSwitchOn']."</a>";
}
?>
		</div><!-- / .col-xs-6 -->
	</div><!-- / .row -->
  ...
  <li class="list-group-item">
	<div class="row">
		<div class="col-xs-6">
<?php
$gpiostatus = exec("/bin/systemctl status phoniebox-rgb-leds.service | grep running");
if ($gpiostatus != "") {
	print $lang['globalRGBLeds'].' <span class="label label-success">'.$lang['globalEnabled'].'</span>';
	print '</div><!-- / .col-xs-6 -->';
	print '<div class="col-xs-6">';
	print "<a href='?rgbledstatus=turnoff' class='btn btn-sm btn-danger'><i class='mdi mdi-cancel'></i> ".$lang['globalSwitchOff']."</a>";
}
else {
	print $lang['globalRGBLeds'].' <span class="label label-danger">'.$lang['globalDisabled'].'</span>';
	print '</div><!-- / .col-xs-4 -->';
	print '<div class="col-xs-4">';
	print "<a href='?rgbledstatus=turnon' class='btn btn-sm btn-success'><i class='mdi mdi-play'></i> ".$lang['globalSwitchOn']."</a>";
}
?>
		</div><!-- / .col-xs-6 -->
	</div><!-- / .row -->
